...
sql_create_asset_table = """CREATE TABLE IF NOT EXISTS {} (	
                        ...
                        );""".format(config.DB_ASSET_TABLE_CRYPTO)
                        
sql_create_asset_table_index = """CREATE INDEX {} ON {} (time,symbol);""".format(config.DB_ASSET_TABLE_INDEX_CRYPTO,config.DB_ASSET_TABLE_CRYPTO)
