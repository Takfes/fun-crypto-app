...
sql_create_asset_table = """CREATE TABLE IF NOT EXISTS {} (	
                        ...
                        );""".format(config.DB_ASSET_TABLE_FUTURES_15)
                        
sql_create_asset_table_index = """CREATE INDEX {} ON {} (openTimets,symbol);""".format(config.DB_ASSET_TABLE_FUTURES_15_INDEX,config.DB_ASSET_TABLE_FUTURES_15)
