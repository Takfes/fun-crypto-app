...
sql_drop_assets_table = """DROP TABLE IF EXISTS {};""".format(config.DB_ASSET_TABLE_CRYPTO)
                        
sql_create_asset_table_index = """DROP INDEX IF EXISTS {};""".format(config.DB_ASSET_TABLE_CRYPTO)
