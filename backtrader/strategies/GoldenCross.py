...
class GoldenCross(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.fast_ma = bt.indicators.SMA(
            self.data.close,period=self.params.fast,plotname=f'{self.p.fast} moving average'
        )
        self.slow_ma = bt.indicators.SMA(
            self.data.close,period=self.params.slow,plotname=f'{self.p.slow} moving average'
        )
